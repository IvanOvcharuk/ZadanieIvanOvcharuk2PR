...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.dod).setOnClickListener {
            findViewById<TextView>(R.id.wyswietlanie).text = findViewById<TextView>(R.id.wyswietlanie).text.toString() + findViewById<TextInputEditText>(R.id.wprowadzenie).text.toString()
        }
        findViewById<Button>(R.id.dodawanie).setOnClickListener {
            ...
            findViewById<TextView>(R.id.wyswietlanie).text = odpowiedz.toString()
